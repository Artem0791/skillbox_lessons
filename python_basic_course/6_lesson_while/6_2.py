...
print('{}, ваша задолженность составляет {} рублей.'.format(name_debtor, duty))
repayment = int(input('Сколько рублей вы внесёте прямо сейчас, чтобы её погасить? '))

while repayment < duty:
    print('Маловато, {}. Давайте ещё раз.'.format(name_debtor))
    repayment = int(input('Сколько рублей вы внесёте прямо сейчас, чтобы её погасить? '))
print('Отлично, {}! Вы погасили долг. Спасибо!'.format(name_debtor))
