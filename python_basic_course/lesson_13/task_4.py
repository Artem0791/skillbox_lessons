exponent = input('Введите экспоненциальную форму числа: ')


def divider(exponent, n):
    divide_num = exponent.split('e')
    return divide_num[n]


m = divider(exponent, 0)
p = divider(exponent, 1)

print('Мантисса = {}, экспонента = {}'.format(m, p))
